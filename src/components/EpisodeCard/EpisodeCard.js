      ...
      {isDetailed ? (<>
        <div className="d-flex justify-content-between">
          <div className="flex-grow-1 p-2">
            ...
            <Card.Subtitle className="mb-3 fst-italic fw-normal">By {episode.podcast ? (episode.podcast.publisher || episode.podcast.publisher_original) : null}</Card.Subtitle>
            <br />
            <div className="d-flex justify-content-between">
              <Card.Subtitle className="fw-normal">{getYear(episode.pub_date_ms)}</Card.Subtitle>
              <Card.Subtitle className="fw-normal">{getTime(episode.audio_length_sec)}</Card.Subtitle>
            </div><br/>
          ...
          <div className="ms-3">
            <img src={episode.thumbnail} alt={`Episode thumbnail`} style={{ width: "250px", height: "250px" }} />
          </div>
        </div>
      </>
      ) : (<>
